...
const AdminSignupPage: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const {confirmPassword, acceptTerms, ...adminData} = formData;
    dispatch(
      signupStart({
        userType: 'ADMIN',
        ...adminData,
  ...
  //     console.log('AdminLoginPage - roles:', roles);
  //     console.log('AdminLoginPage - adminRole:', adminRole);
  //     if (adminRole) {
      ...
      >
        ...
        >
          ...
          >
            ...
            <Link color='secondary' href='/admin' sx={{ml: 2}}>
              Login
            </Link>
          </Typography>
          <RoleSelectorSignUp />
